...
- A trained multi-feature rent model exported from [ML-LinearRegression](https://github.com/NagaMallesh/ML-LinearRegression)
...
## Export Model Artifact (From [ML-LinearRegression](https://github.com/NagaMallesh/ML-LinearRegression))
...
- Error: `Model file not found`
  - Export the model from [ML-LinearRegression](https://github.com/NagaMallesh/ML-LinearRegression).
...
- Model training and export live in the [ML-LinearRegression](https://github.com/NagaMallesh/ML-LinearRegression) repository.
